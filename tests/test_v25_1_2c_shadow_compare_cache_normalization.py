...
class TestV2512cShadowCompareCacheNormalization(unittest.TestCase):
    ...
    def test_v2512c_metadata_versions(self):
        self.assertEqual(MODEL_VERSION, "V25.1.2c-shadow-compare-cache-normalization")
        self.assertEqual(CONFIG_VERSION, "2026-07-01-v25.1.2c-shadow-compare-hardening")
        self.assertEqual(FEATURE_SET_VERSION, "v25.1.2c-compare-cache-normalization")
